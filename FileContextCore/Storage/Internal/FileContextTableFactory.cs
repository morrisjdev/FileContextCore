...
namespace FileContextCore.Storage.Internal
{
        ...
        : Microsoft.EntityFrameworkCore.ChangeTracking.Internal.IdentityMapFactoryFactoryBase, IFileContextTableFactory
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public FileContextTableFactory([NotNull] ILoggingOptions loggingOptions)
        {
        ...
        [UsedImplicitly]
        private static Func<IFileContextTable> CreateFactory<TKey>(IKey key, bool sensitiveLoggingEnabled)
