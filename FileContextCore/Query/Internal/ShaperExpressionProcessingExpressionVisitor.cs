...
namespace FileContextCore.Query.Internal
{
    ...
    {
        private readonly FileContextQueryExpression _queryExpression;
        ...
        public ShaperExpressionProcessingExpressionVisitor(
            [CanBeNull] FileContextQueryExpression queryExpression, [NotNull] ParameterExpression valueBufferParameter)
        {
